                                ...
                                <div class="col-sm-12" style="font-size: small">
                                    ...
                                    <div class="col-sm-7" style=" padding: 0; margin: 10px; border: 1px solid #BDBDBD; border-radius: 0;">
                                        <div style="background-color: darkslategray; padding: 5px; border: 1px solid #BDBDBD">
                                            <h5 style="font-size: small; text-transform: uppercase; color: white; text-align: center"><?php echo $SingleEnterprise->name?></h5>
                                        </div>
                                        ...
                                        <div class="" style="padding: 10px; font-size: small; background-color: white">
                                            ...
                                            <table class="table-bordered table table-stripped" style="font-size: smaller">
                                                ...
                                                $num = 1;
                                                $total_items = 0;
                                                foreach ($soldProducts as $report){
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $num++?></td>
                                                        <td><?php echo $report['sales_date']?></td>
                                            ...
                                            <table class="table-bordered table table-stripped" style="font-size: smaller">
                                                ...
                                                $num = 1;
                                                $total_items = 0;
                                                foreach ($ProductsOrdered as $report){
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $num++?></td>
                                        ...
                                        <a href="<?php echo base_url()?>index.php/Products/enterpriseReportsPdf">
