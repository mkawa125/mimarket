...
<div id="container" class="">
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" style="margin-top: 63px">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="<?php echo base_url()?>index.php/Direct/individual"><i class="fa fa-shopping-cart"></i>My Enterprise</a></li>
    ...
    <section id="main-content" style="font-size: smaller">
        <section class="wrapper">
            ...
            <div class="col-sm-5 col-md-offset-3" style="background-color: whitesmoke">
                <form role="form" action="<?php echo base_url()?>index.php/Messages/validate" method="post">
