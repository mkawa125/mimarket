                            ...
                            <div class="row items" style="margin-top: 1px">
                                <div class="col-sm-12" style="margin-top: 0px">
                                    ...
                                    foreach($productDetails->result() as $row){
                                        ...
                                        $_SESSION['product_details'] = $row->product_details;
                                        ?>
                                        <div class="col-sm-4" style="font-size: small; border: 1px solid #D5D8DC; padding: 5px; margin: 0">
                                            ...
                                            <h4><strong  style="color: red">Product Price: <?php echo $row->product_price?></strong> tzs/piece</h4>
<!--                                            <button class="btn btn-success" type="button" style="float: right"><i class="fa fa-plus"></i> Add image</button>-->
                                        </div>

                                        <div class="col-sm-7" style="font-size: small; border: 1px solid #D5D8DC; padding: 5px; margin-left: 10px; background-color: whitesmoke">
                                            <table class="table table-bordered table-striped table-hovere">
                                                <thead style="background-color: darkslategray; color: white">
                                                <tr style="color: white">
                                                    <th style="color: white">Product Attributes</th>
                                                    <th style="color: white">Descriptions</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->quantity?>
                                                        <button style="float: right" type="button" class="btn btn-success btn-xs"
                                                            data-toggle="modal" data-target="#myModal2<?php echo $row->product_id; ?>">
                                                            <i class="fa fa-plus"> Update</i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Product orders:</strong></td>
                                                    <td><?php echo $row->ProductOrders?></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Product Visitors:</strong></td>
                                                    <td>
                                                        <?php echo $row->product_views?>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <label><strong style="color: cornflowerblue"> Phone number:</strong> <span style="color: "> <?php echo $row->phone?> </span></label><br><a href="#">
                                                <button type="button" data-toggle="modal" data-target="#myModal<?php echo $row->product_id; ?>" style="float: right" class="btn btn-primary"><i class="fa fa-edit"></i> Edit Product</button>
                                            </a>
                                        </div>
                                                    ...
                                                    <form action="<?php echo base_url()?>index.php/Products/DirectOrders?prod=<?php echo $row->product_id; ?>" method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group input-group">
                                                                ...
                                                                <input class="form-control" placeholder="Product Quantity" name="name" required
                                                                       type="text" title="Enter product name" value="<?php echo $_SESSION['product_name']?>">
                                                            </div>
                                                            <div class="form-group input-group">
                                        ...
                                        <div class="modal fade" id="myModal2<?php echo $row->product_id; ?>" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title" style="color: cornflowerblue"><i class="fa fa-edit"></i>Update the product Qunatity</h4>
                                                    </div>
                                                    <form action="<?php echo base_url()?>index.php/Products/UpdateQuantity?prod=<?php echo $row->product_id; ?>" method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-primary" name="add"><i class="fa fa-plus"></i> Add Product</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
