                                    ...
                                    <div class="col-sm-3" style=" padding: 0; margin-right: 0; border: 1px solid #BDBDBD; border-radius: 0;">
                                        ...
                                        <div class="" style="padding: 15px; font-size: small; background-color: whitesmoke">
                                            <ol style="list-style: square">
                                                <li style="padding: 5px; background-color: #BDBDBD; border-radius: 4px"><a href="<?php echo base_url()?>index.php/Products/viewOrders" style="margin: 5px;">Latest sent<span> (<?php foreach ($orderCount as $complete) echo $complete['total']?>)</span></a>
                                                ...
                                                <li style="padding: 5px"><a href="<?php echo base_url()?>index.php/Products/customerDirect" style="margin: 5px;">Direct Orders<span> (<?php foreach ($orderCount as $paid) echo $paid['total']?>)</span></a>
