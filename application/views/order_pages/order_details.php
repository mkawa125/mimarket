                                            ...
                                            <div class="col-sm-12" style="border: 1px solid #BDBDBD; padding: 5px; font-size: smaller; background-color: whitesmoke">
                                                <?php if (isset($orderDetails)){
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <p>
                                                            <?php
                                                            if ($orderDetails->order_document != NULL){
                                                                $_SESSION['document_name'] = $orderDetails->order_document;
                                                                ?>
                                                                <a href="<?php echo base_url()?>index.php/Products/DownloadOrderDocument">Click here to download order document</a>
                                                           <?php } ?>
                                                ...
                                                if (isset($cartProduct)){
                                                    ...
                                                    <div class="" align="right" style="padding: 5px">
                                                        ...
                                                        <a href="<?php echo base_url()?>index.php/Products/orderProcessing?ord=<?php echo $_SESSION['order']?>">
                                                            <button type="button" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add Product</button> </a>
                                                    </div>
                                                <?php } ?>
                                            </div>
