                                ...
                                <div class="col-sm-3" style=" padding: 0; margin-right: 0; border: 1px solid #BDBDBD; border-radius: 0;">
                                    ...
                                    <div class="" style="padding: 15px; font-size: small; background-color: whitesmoke">
                                        <ol style="list-style: square">
                                            ...
                                            <li style="padding: 5px; background-color: #BDBDBD; border-radius: 4px"><a href="<?php echo base_url()?>index.php/Products/customerOrdersPaid" style="margin: 5px;">Paid Orders<span> (<?php foreach ($paidCount as $paid) echo $paid['total']?>)</span></a>
