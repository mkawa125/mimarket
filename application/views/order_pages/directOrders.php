                        ...
                        <div class="col-lg-11">
                            ...
                            <div class="row items" style="margin-top: 5px">
                                <div class="col-sm-3" style=" padding: 0; margin-right: 0; border: 1px solid #BDBDBD; border-radius: 0;">
                                    ...
                                    <div class="" style="padding: 15px; font-size: small; background-color: whitesmoke">
                                        <ol style="list-style: square">
                                            <li style="padding: 5px"><a href="<?php echo base_url()?>index.php/Products/viewOrders" style="margin: 5px;">Latest sent<span> (<?php foreach ($orderCount as $complete) echo $complete['total']?>)</span></a>
                                ...
                                <div class="col-sm-8" style="font-size: smaller; border: 1px solid #BDBDBD; margin-left: 10px">
                                    <div class="row">
                                        <div style="background-color: chocolate; padding: 5px; border: 1px solid #BDBDBD">
                                            <h5 style="font-size: small; color: white; text-align: center">DIRECT SENT ORDERS</h5>
                                        </div>
                                        <?php
                                        $num = 1;
                                        foreach($directOrders->result() as $row){
                                            ...
                                            <div class="row" style="margin: 5px; border: 1px solid #BDBDBD; padding: 10px; background-color: whitesmoke">
                                                ...
                                                <div class="col-sm-3" style="">
                                                    <strong style="color: cornflowerblue"><?php echo $row->ProductName?></strong>
                                                </div>
                                                <div class="col-sm-4" >
                                                    <?php echo $row->name?>
                                                </div>
                                                ...
                                                <div class="col-sm-2" style="float: right">
                                                    <a href="<?php echo base_url()?>index.php/Products/customerOrderDetails?ord=<?php echo $row->direct_order_id?>"><button style="float: right" class="btn btn-xs btn-default"><i class="fa fa-eye"></i> Details</button></a>
                                                </div>
                                            </div>
                                        <?php } ?>
                                    </div>
