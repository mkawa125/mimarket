                ...
                <div class="col-lg-10 col-sm-offset-1">
                    ...
                    <section class="">
                        <div class="col-lg-11">
                            ...
                            <?php $email_not_sent = $this->session->flashdata('email_not_sent');
                            if ($email_not_sent){?>
                                <div class="alert alert-danger alert-dismissible"><?php echo $email_not_sent?>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span></div>
                                <?php
                            }
                            ...
                            <div class="row items" >
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <table  class="table table-striped table-bordered" id="enterprise" style="font-size: small">
                                        ...
                                        <?php
                                        $num = 1;
                                        foreach($allStoreDetails as $row){
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($status == 0){?>
                                                        <badge class="btn btn-info btn-xs"> New </badge>
                                                    <?php } elseif($status == 1){?>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal<?php echo $row['enterprise_id']; ?>"><i class="fa fa-trash"></i> Delete</button>
