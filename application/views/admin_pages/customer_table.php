                        ...
                        <div class="col-lg-11">
                            ...
                            <div class="row items" >
                                <div class="col-lg-12" style="background-color: #A4A4A4; padding: 10px; border-radius: 0;">
                                    <div class="col-lg-9">
                                        <h5 style="color: white">Online marketing system registered customers</h5>
                                    </div>
                                    <div class="col-lg-3">
                                    </div>
                                </div>
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Are you sure you want to delete <a href="#"><?php echo $row['full_name']?></a>?</p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                                    <a href="<?php echo base_url()?>index.php/Admin/deleteStore?ent=<?php echo $row['user_id']; ?>"><button type="button" class="btn btn-danger"> Yes..! Delete</button></a>
                                                                </div>
                                                            </div>
