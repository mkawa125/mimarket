                        ...
                        <div class="col-lg-11">
                            ...
                            <div class="row items" >
                                <div class="col-lg-12" style="background-color: darkslategrey; padding: 10px">
                                    ...
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url()?>index.php/Direct/newEnterprise?user=<?php echo $_SESSION['admin_id']?>">
                                            <button class="btn btn-success"><i class="fa fa-plus">Add New Enterprise</i></button>
                                        </a>
                                    </div>
                                </div>
