                ...
                <div class="col-lg-10 col-sm-offset-1">
                    ...
                    <section class="">
                        <div class="col-lg-11">
                            ...
                            ?>
                            <div class="row items" >
                                <div class="col-lg-12" style="background-color: #F78181; padding: 10px">
                                    <div class="col-lg-9">
                                        <h5 style="color: white">Online marketing system: Denied stores</h5>
                                    </div>
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <p style="color: red"><strong>Stores listed in the table below has been denied from being registered to mi market online marketing system</strong></p>
                                        ...
                                        foreach($deniedStore as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url()?>index.php/Admin/storeDetails?ent=<?php echo $row['enterprise_id']; ?>"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> View</button></a>
                                                    <a href="<?php echo base_url()?>index.php/Admin/verifyStore?ent=<?php echo $row['enterprise_id']; ?>"><button type="button" class="btn btn-success btn-xs" title="Verify store"><i class="fa fa-check"></i></button></a>
                                                    <!-- Modal -->
