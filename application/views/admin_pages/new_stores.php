    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    <a href="<?php echo base_url()?>index.php/Products/viewOrders" class=""><i class="fa fa-plus"></i>
                        <span>Customers</span>
                    </a>
                </li>
                ...
                <div class="col-lg-10 col-sm-offset-1">
                    ...
                    <section class="">
                        <div class="col-lg-11">
                            ...
                            ?>
                            <div class="row items" >
                                <div class="col-lg-12" style="background-color: #329acf; padding: 10px">
                                    <div class="col-lg-9">
                                        <h5 style="color: white; text-align: center">Mimarket Online marketing system New/Non-verified stores</h5>
                                    </div>
                                    <div class="col-lg-3">
                                        <?php echo date('M, d Y')?>
                                    </div>
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <p style="color: cornflowerblue"><strong>Stores listed in the table below are new stores and has no been verified to mi market online marketing system</strong></p>
                                    <table  class="table table-striped table-bordered" id="enterprise" style="font-size: small">
                                        ...
                                        <?php
                                        $num = 1;
                                        foreach($newStoreDetails as $row){
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url()?>index.php/Admin/denyRegistration?ent=<?php echo $row['enterprise_id']; ?>"><button type="button" class="btn btn-default btn-xs" title="suspend"><i class="fa fa-eye-slash"></i></button></a>
                                                    <!-- Modal -->
