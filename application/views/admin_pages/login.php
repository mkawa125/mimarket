        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                <div class="panel-heading" style="background-color: cadetblue">
                    <h3 class="panel-title" style="text-align: center">Admin login</h3>
                </div>
                <div class="panel-body">
                    <form role="form" action="<?php echo base_url()?>index.php/Admin/login" method="post" name="login">
                        <fieldset>
                            ...
                            <button style="float: right" class="btn btn-primary" type="submit"><i class="fa fa-key"></i> Login</button>
                        </fieldset>
                    </form>
                </div>
            </div>
