                ...
                <div class="col-lg-10 col-sm-offset-1">
                    ...
                    <section class="">
                        <div class="col-lg-11">
                            ...
                            ?>
                            <div class="row items" >
                                <div class="col-lg-12" style="background-color: #df8040; padding: 10px">
                                    <div class="col-lg-9">
                                        <h5 style="color: white">Online marketing system: Suspended stores</h5>
                                    </div>
                                ...
                                <div class="col-sm-12" style="margin-top: 10px">
                                    <p style="color: red"><strong>Stores listed in the table below has been suspended and can no longer be visible by users</strong></p>
                                    <table  class="table table-striped table-bordered" id="enterprise" style="font-size: small">
                                        ...
                                        <?php
                                        $num = 1;
                                        foreach($suspendedStoreDetails as $row){
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url()?>index.php/Admin/unSuspendStore?ent=<?php echo $row['enterprise_id']; ?>"><button type="button" class="btn btn-default btn-xs" title="un suspend"><i class="fa fa-eye"></i></button></a>
                                                    <!-- Modal -->
