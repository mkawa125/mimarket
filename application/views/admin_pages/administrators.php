                ...
                <div class="col-lg-10 col-sm-offset-1">
                    ...
                    <section class="">
                        <div class="col-lg-11">
                            ...
                            ?>
                            <div class="row items" >
                                <div class="col-lg-12" style="background-color: #A4A4A4; padding: 10px; border-radius: 4px;">
                                    <div class="col-lg-9">
                                        <h5 style="color: white">Online marketing system, system administrators</h5>
                                    </div>
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url()?>index.php/Admin/addAdministrator">
                                            <button class="btn btn-default"><i class="fa fa-plus"> Create New Administrator</i></button>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <table  class="table table-striped table-bordered" id="enterprise" style="font-size: small">
                                        ...
                                        foreach($admins as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: cornflowerblue"><?php echo $row['admin_date'] ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal<?php echo $row['admin_id']; ?>"><i class="fa fa-trash"></i></button>
                                                    <a href="<?php echo base_url()?>index.php/Admin/storeDetails?ent=<?php echo $row['admin_id']; ?>"><button type="button" class="btn btn-primary btn-xs">View</button></a>
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="myModal<?php echo $row['admin_id']; ?>" role="dialog">
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Are you sure you want to delete <a href="#"><?php echo $row['Admin_name']?></a>?</p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                                                    <a href="<?php echo base_url()?>index.php/Admin/deleteStore?ent=<?php echo $row['admin_id']; ?>"><button type="button" class="btn btn-danger"> Yes..! Delete</button></a>
                                                                </div>
                                                            </div>
